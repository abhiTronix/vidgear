...
**Warning:** In `javascripts` folder, `clappr.min.js`, `clappr-level-selector.min.js` like third-party javascripts are made avaliable under [BSD-3-Clause License](https://github.com/clappr/clappr/blob/dev/LICENSE), whereas `dash-shaka-playback.js` is available under [Apache License 2.0](https://github.com/google/shaka-player/blob/master/LICENSE) seperately.
