...
> Threaded Queue Mode is designed exclusively for VidGear's Videocapture Gears _(namely FFGear, CamGear, VideoGear)_ and few Network Gears _(such as NetGear(Client's end))_ for achieving high-performance, asynchronous, error-free video-frames handling. 
