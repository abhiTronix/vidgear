...
!!! info "We're also using [`reducer`](../../../../bonus/reference/helper/#vidgear.gears.helper.reducer) Helper method for reducing frame-size on-the-go for additional performance."
