...
### You can checkout `vidgear` [Wiki-Section](https://github.com/abhiTronix/vidgear/wiki/VidGear-Gears(Classes)) for detailed documentation with examples for each Class(`Gear`).
...
[@abhiTronix](https://github.com/abhiTronix)
